...
const candidateReviewLinks = [
  ...
  ["不足点10項目 回収実装", "899_gap_resolution_execution_20260606.html", "未完成だった論点を、必須データ、決算反応、質的検証、配分、売買、税制のゲートへ落とした版。"],
  ["不足点10項目 回収トラッカー", "913_gap_closure_tracker_20260606.html", "残っている不足点、次にやること、購入判断への影響を一覧で確認する。"],
  ["最終10社 判定ワークベンチ", "908_final10_decision_workbench_20260606.html", "6月イベント後の市場判定と各銘柄の確認状況を入力し、中心候補・条件付き・補欠・監視・除外へ分類する。"],
  ["現時点 判定スナップショット", "909_final10_current_snapshot_20260606.html", "ワークベンチの初期値から、保守判定と緑通過後の仮判定を固定表示する。"],
  ["購入前 最終ゲートチェック", "910_prebuy_final_gate_checklist_20260606.html", "候補、市場、NISA口座、税制、記録がそろっているかを購入前に確認する。"],
  ["購入準備 判定ボード", "916_purchase_readiness_board_20260606.html", "市場、候補、配分、NISA口座、税制、記録がそろっているかを一画面で判定する。"],

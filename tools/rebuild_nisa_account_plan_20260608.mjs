...
<body>
  <section class="page">
    ...
    <div class="danger">成人本人のNISA口座について、第三者が本人のID・パスワードを預かって継続的に売買する形は採用しない。本人の同意があっても、証券会社が認める代理権限・口座規約・登録業務の範囲を確認しない限り、安全な運用形態とは扱わない。</div>
    <div class="footer">本資料は制度比較・実務整理であり、投資助言、税務代理、法務代理、または自動売買の指示書ではありません。最終判断は証券会社、公式規約、専門家確認に基づいて行います。</div>
  </section>

...
<body>
  <section class="page">
    ...
    <div class="lead">
      この報告書では、他人名義のNISA口座を直接操作する案を短期の本命にせず、本人名義のNISA口座で本人が取引し、投資資金は個人間の正式な借入として整理する方法を中心に説明します。あわせて、証券会社の正式代理制度、家族サポート証券口座、IFA連携、NISA対応ラップ等は、実行難度が高い補助案として位置付けます。最後に、他人の口座を触る場合に問題になり得る法律・規制を整理します。
    </div>
    <div class="cards">
      <div class="card"><b>本命の代替案</b><div class="value">本人NISA + 借入</div><p>本人が自分の口座で買い、資金は契約書付きの借入として整理する。</p></div>
      <div class="card"><b>必要な証拠</b><div class="value">契約・振込・返済</div><p>金銭消費貸借契約書、振込履歴、返済予定表を残す。</p></div>
      <div class="card"><b>避ける形</b><div class="value">返済実態なし</div><p>ある時払い、出世払い、損したら返さない、返済免除を避ける。</p></div>
      <div class="card"><b>補助案</b><div class="value">正式代理等</div><p>代理制度やIFA等は確認対象だが、短期の本命ではない。</p></div>
    </div>
  </section>
  ...
  <section class="page">
    <h2>3. 補助案: 実行難度が高いルート</h2>
    <div class="note">
      以下は、完全に不要という意味ではありません。ただし、再来週の購入に間に合わせる本命案ではなく、証券会社・専門家確認を経て使えるかを判断する補助案です。
    </div>

...
story = [
    p("5月28日 作業報告", title),
    p("本資料は、候補10社の選定に使う比較指標を追加し、S&P500との比較と下落リスクを確認できる形に整理した作業報告です。過去5年・10年の実績は将来予測ではなく、候補比較のための確認値として扱います。", note),
    p("1. 本日の作業内容", h),
    ...
    p("下表は、過去10年CAGRの加重平均が続いた場合の参考比較です。将来予測ではありません。今後、過去時点から選定した場合の1年後成績を検証します。", note),
